...
def precompute_clip_stl10_train_image_embeddings(exp_name, data_path):
    precompute_clip_stl10_image_embeddings(
...
def precompute_clip_stl10_test_image_embeddings(exp_name, data_path):
    precompute_clip_stl10_image_embeddings(
...
def get_stl10_open_images_filtered_dataset_90(transform=get_stl10_transform()):
